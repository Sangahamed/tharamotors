...
@push('scripts')
    <script>
        ...
        function toggleFaq(btn) {
            ...
            var allFaqs = document.querySelectorAll('[data-faq]');
            ...
            if (answer.classList.contains('open')) {
                ...
                faqItem.classList.remove('bg-gray-200');
                faqItem.classList.add('bg-gray-200/60');
            } else {
                answer.classList.add('open');
                answer.style.maxHeight = answer.scrollHeight + 'px';
                chevron.style.transform = 'rotate(180deg)';
                faqItem.classList.add('bg-gray-200');
                faqItem.classList.remove('bg-gray-200/60');
            }
        }
